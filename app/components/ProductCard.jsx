    ...
    return (
        <div className='border border-[#E9E9E9] px-[8px] pt-[8px] rounded-[10px]'>
            <div className='w-[313.15px] h-[313.15px] relative rounded-[10px]'>
                ...
                <svg onClick={favHandler} className='cursor-pointer absolute z-10 top-[22px] right-4' xmlns="http://www.w3.org/2000/svg" width="24" height="21" viewBox="0 0 24 21" fill={love === false ?`none` : `#FF5555`}>
