...
const ProductCard = ({ img, dis, header, price, id }) => {
    ...
    return (
        ...
        <div className='border border-[#E9E9E9] px-[6px] lg:px-[8px] cursor-pointer pt-[5px] lg:pt-[8px] rounded-[10px]'>
