    ...
    return (
        <>
            <div className='border-b border-[#EFEEEE] border-[1.5px]'>
                <div className='max-w-[1401px] mx-auto mt-[33px]'>
                    <div className='hidden lg:flex items-center'>
                        ...
                        <div className='ml-[41px] flex justify-center items-center gap-x-[6px]'>
                            ...
                            <p className={`text-${pColor} leading-[19.2px] flex items-center gap-x-[8px]`}>My Cart <div className='w-5 h-5 rounded-full bg-[#FF5D5D] text-white flex justify-center items-center  text-[12px]'>
                                1
                            </div></p>
                        </div>
                    </div>
                    <div className='mx-[33px] flex justify-between items-center mt-[34px]'>
                        {menuItems.map(item => <p className={`text-${menuColor} cursor-pointer hover:text-secondary-0 uppercase font-medium pb-[6px] hover:border-b hover:border-b-secondary-0 px-[11px]`} key={item}>{item}</p>)}
                    </div>
                </div>
            </div>
        </>
